...
class SportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post sports_url, params: { sport: { date: @sport.date, name: @sport.name, text: @sport.text, time: @sport.time, tittle: @sport.tittle } }
    end
  ...
  test "should update sport" do
    patch sport_url(@sport), params: { sport: { date: @sport.date, name: @sport.name, text: @sport.text, time: @sport.time, tittle: @sport.tittle } }
