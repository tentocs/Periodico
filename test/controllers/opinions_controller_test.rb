...
class OpinionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post opinions_url, params: { opinion: { date: @opinion.date, name: @opinion.name, text: @opinion.text, time: @opinion.time, tittle: @opinion.tittle } }
    end
  ...
  test "should update opinion" do
    patch opinion_url(@opinion), params: { opinion: { date: @opinion.date, name: @opinion.name, text: @opinion.text, time: @opinion.time, tittle: @opinion.tittle } }
